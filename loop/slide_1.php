                ...
                <div class='col-lg-8'>
                    <div class='row'>
                        ...
                        <div class='col-12 col-lg-4 d-flex align-items-center justify-content-center'>
                            <div class='team_logo rounded-circle d-flex justify-content-center alig-items-center bg-light'>
                                <img width='40px;' height='40px' src=' {$teams['team1']['logo']} alt=' {$teams['team1']['name']} '>
                            </div>
                            <div class='mx-5 d-lg-none d-block'>
                                <img src='$cross_img' width='40px;' height='40px' alt='teamvs'>
                            </div>                                
                            <div class='team_logo rounded-circle d-flex justify-content-center alig-items-center bg-light'>
                                <img width='40px;' height='40px' src=' {$teams['team2']['logo']} alt=' {$teams['team2']['name']} '>
                            </div>
                        </div>
