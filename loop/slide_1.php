...
echo "<div class='owl-item' >
        <div class='item' style='background-image:linear-gradient(145deg,#03b0f4 0,#051421c4 50%,#dc213e 100%),url( $slide_bg ); background-repeat:no-repeat;background-size:cover;'>
            <div class='row align-items-center'>
                <div class='col-lg-7'>
                    <p class='text-center text-muted mb-4' >Enfrentamiento</p>
                    <div class='row'>
                        <div class='col-12 col-lg-4 d-flex align-items-center justify-content-center'>
                            <div class='team_logo team_logo rounded-circle p-4 bg-light'>
                                <img width='40px;' height='40px' src=' {$teams['team1']['logo']} ' class='img-fluid' alt=' {$teams['team1']['name']} '>
                            </div>
                            <div class='mx-5 d-lg-none d-block'>
                                <img src='$cross_img' width='40px;' height='40px' alt='teamvs'>
                            </div>                                
                            <div class='team_logo team_logo rounded-circle p-4 bg-light'>
                                <img width='40px;' height='40px' src=' {$teams['team2']['logo']} ' class='img-fluid' alt=' {$teams['team2']['name']} '>
                            </div>
                        </div>
                        <div class='col-12 col-lg-8 text-center my-4'>
                            <span class='d-none d-sm-none d-md-block text-light team-name' > {$teams['team1']['name']} <strong class='text-light'>VS</strong>  {$teams['team2']['name']} </span>
                            
                            <span class='d-block d-sm-block d-md-none text-light text-uppercase team-name'> {$teams['team1']['acronimo']}rt <strong class='text-light'>VS</strong> y {$teams['team2']['acronimo']} </span>
