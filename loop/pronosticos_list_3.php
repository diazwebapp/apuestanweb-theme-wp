                    ...
                    <div class='event2_box'>
                            ...
                            <div class='event2_box_middle_content'>
                                ...
                                <div class='row align-items-center'>
                                    <div class='col-6'>
                                        <a href='{$bookmaker['ref_link']}' class='pb-2 pt-1 btn' style='background:black;'>
                ...
                <div class='event2_box'>
                        ...
                        <div class='event2_box_middle_content'>
                            ...
                            <div class='row align-items-center'>
                                <div class='col-6'>
                                    <a href='{$bookmaker['ref_link']}' class='pb-2 pt-1 btn' style='background:black;'>
                                        <img src='{$bookmaker['logo']}' width='80' height='20' style='object-fit:contain;' alt='logo casa de apuesta' >
                                    </a>
                                </div>
                                <div class='col-6'>
                                    <a href='{$bookmaker['ref_link']}' class='p-2 btn btn-primary font-weight-bold' rel='nofollow noopener noreferrer' target='_blank'>Juega ahora</a>
