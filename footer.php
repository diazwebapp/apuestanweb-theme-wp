                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="row bg-light mx-auto text-center" style="width:320px;height:320px;border-radius:50%;align-items:center;">
                        <div class="col-12 text-center">
                            ...
                            <button type="button" class="btn btn-primary py-5 m-5" onclick="setAge('si')"><p class="h2" >si</p></button>
                            <button type="button" class="btn btn-secondary py-5 m-5" onclick="setAge('no')"><p class="h2" >no</p></button>
                        </div>
                    </div>
                </div>
            </div> 
