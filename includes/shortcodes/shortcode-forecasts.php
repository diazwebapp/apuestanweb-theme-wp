                    ...
                    <div class='mt_30 dropd order-lg-3'>
                        <div class='blog_select_box'>
                            <select name='ord' id='element_select_forecasts'>
                                ...
                                <option value='yesterday' selected='".(isset($date) and $date == 'yesterday' ? 'selected' : '')."'> ".__('Ayer','jbetting')." </option>
                                <option value='today' selected='".(isset($date) and $date == 'today' ? 'selected' : '')."' >".__('Hoy','jbetting')." </option>
                                <option value='tomorrow' selected='".(isset($date) and $date == 'tomorrow' ? 'selected' : '')."'> ".__('Mañana','jbetting')." </option>
                            </select>
                        </div>
                    </div>
