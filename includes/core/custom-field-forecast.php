        ...
        <div class="row">
            ...
            <div class="col-12" style="position:relative !important;">
                ...
                <div id="imagen-destacada-personalizada" class="d-flex justify-content-around align-items-center" style="width:768px;height:403px;position:relative !important; background-image:url({replacebg});background-repeat:no-repeat;background-size:cover;background-position:center center;">
                    ...
                    <img src="{replace-team-1}" width="130" height="130" target-html-attr="src" ubicacion="left" onclick="aw_set_imgs(this)" id="logo-equipo-1" class="btn btn-outline-light" style="margin-left:17px !important;"/>
                        
                    <img src="{replace-team-2}" width="130" height="130" target-html-attr="src" ubicacion="right" onclick="aw_set_imgs(this)" id="logo-equipo-2" class="btn btn-outline-light" style="margin-right:17px !important;"/>
                </div>
