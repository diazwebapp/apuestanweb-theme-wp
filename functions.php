...
include "includes/shortcodes/shortcode-forecasts-test.php";
...
function jbetting_src()
{
    ...
    add_filter('style_loader_tag', 'añadir_atributos_criticos', 2, 2);
...
function añadir_atributos_criticos($html, $handle) {
    $estilos_criticos = ['bootstrap']; // 94% speed
    //$estilos_criticos = ['main-css']; // 94% speed
    //$estilos_criticos = ['bootstrap','main-css']; // 77% speed
