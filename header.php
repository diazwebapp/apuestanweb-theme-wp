        ...
        <div class="col-6 order-lg-3 col-lg-2 d-flex justify-content-end py-2">
                <?php 
                    ...
                    <div class="navbar navbar-expand-lg">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu position-absolute text-center" style="" aria-labelledby="navbarDropdownMenuLink">
                                        ...
                                        <hr class="mt-2 mb-3">
                                        <a class="dropdown-item text-dark my-3" href="'.  wp_logout_url() .'"><i>❓</i>'.__(' Cerrar sesion','jbetting').'</a>
                        ...
                        echo '<div id="open-search-modal" class="headerbtnsearch rounded py-2 px-3"><?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
...
<path d="M17.029 16.5295L19.5 19.0005" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        echo '<a href="'. wp_login_url() .'" class="border ml-1 rounded border-secondary py-2 px-3" aria-label="Acceder"><?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
