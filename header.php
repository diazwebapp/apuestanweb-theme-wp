        ...
        <div class="col-6 order-lg-3 col-lg-2 d-flex justify-content-end py-2">
                <?php 
                    ...
                    <div class="navbar navbar-expand-lg">
                        ...
                        echo '<div id="open-search-modal" class="headerbtnsearch rounded px-1"><?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
...
<path d="M17.029 16.5295L19.5 19.0005" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        echo '<a href="'. wp_login_url() .'" class="border ml-1 rounded border-secondary pb-1 px-1" aria-label="Acceder"><?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
