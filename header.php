...
<div class="container">
            <div class="row align-items-center form-row">
                ...
                <div class="col-lg-2 order-lg-3 btn_group col-6">
                    ...
                    <a href="<?php echo PERMALINK_VIP ?>" class="headerbtn"><?php $loc = isset($_SESSION["geolocation"]) ? json_decode($_SESSION["geolocation"]) : json_decode(GEOLOCATION); echo $loc->country; ?> </a>
