                    ...
                    <div class="col-md-12 col-lg-6" >
                        <div class="row text-center">                        
                            ...
                            <div class="col-12 my-4 special-single-bk-button" >
                                <b style="background:lightgray;font-size:1.7rem;border-radius:.8rem;" class="px-2 text-body text-uppercase" ><?php echo $bookmaker["bonus_slogan"] ?></b>
                            </div>
                            <div class="col-12 my-3 special-single-bk-button">                                
                                <a href="<?php echo $bookmaker["ref_link"] ?>" class="badge badge-primary px-5 font-weight-light" style="font-size:1.7rem;border-radius:.8rem;" target="_blank"><?php echo _e("Visitar") ?> <i class="fa fa-external-link ml-5" aria-hidden="true"></i></a>                                    
                            </div>
                        </div>
                    </div>
