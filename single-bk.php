                    ...
                    <div class="col-md-12 col-lg-6" >
                        <div class="row text-center">                        
                            ...
                            <div class="col-12 my-3 special-single-bk-button">                                
                                <a href="<?php echo $bookmaker["ref_link"] ?>" class="badge badge-primary px-5 font-weight-light" style="font-size:1.7rem;border-radius:.5rem;" target="_blank"><?php echo _e("Visitar") ?> <i class="fa fa-external-link ml-5" aria-hidden="true"></i></a>                                    
                            </div>
                        </div>
                    </div>
